    ...
    return (
     ...
     <div className="grid  h-screen  bg-white"> 
        ...
        <div className="flex ml-32  flex-col w-10/12 h-screen ">
            ...
            >Honda City 2024 Price in Pakistan, Images, Reviews & Specs</p>
            <div className="flex items-center justify-center mt-14">
               <Image src="/Honda_City.jpg" className="flex justify-center hover:cursor-pointer "
            ...
            <p className="flex text-left">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem eaque ea, quo quibusdam dolorem 
                ...
                <p className="text-xl mt-7 font-bold text-green-700">PKR 4500000</p>

                <Link href="/carDetails/payment/paycity" className="grid mx-auto hover:bg-blue-700 mt-10 items-center w-44 rounded-lg 
