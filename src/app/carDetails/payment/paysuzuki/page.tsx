...
export default function SuzukiAlto() {
    return (
     ...
     <div className="grid h-screen bg-white grid-cols-2 "> 
            ...
            <h1 className="text-4xl mt-10 text-center font-bold text-black">Suzuki Alto</h1>
            <p className="text-2xl text-black">The Suzuki Alto is a car manufactured by Suzuki in pak.</p>
            <Image src="/Suzuki_Alto.png" className="mt-8 bg-blue-100 ml-16" alt="Corolla" width={500} height={200} />
        </div>
        <div className=" grid-flow-col bg-blue-100">
        <div>
