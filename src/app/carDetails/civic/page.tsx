...
export default function HondaCivic() {
    return (
     ...
     <div className="grid  h-screen  bg-white"> 
        ...
        <div className="flex ml-28  flex-col w-10/12 h-screen ">
            <p className="text-4xl underline underline-offset-2  font-bold text-center mt-20"
            >Honda CiVic 2024 Price in Pakistan, Images, Reviews & Specs</p>
            <div className="flex items-center justify-center mt-14">
               <Image src="/Honda_Civic.jpg" className="flex justify-center hover:cursor-pointer "
